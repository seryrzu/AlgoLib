...
sys.path.append(os.path.join(this_dir, os.path.pardir, os.path.pardir, 'py_utils'))
...
def main():
    ...
    parser.add_argument("-N", help="Number of tests", default=50, type=int)
    ...
    parser.add_argument("--max-size", help="Min sample size", default=100000, type=int)
    ...
    tests_hpp_generator(filenames, os.path.join(this_dir, 'tests_fn.hpp'), 'algolib::sorting')
